...
//     const { id, label, amount, status, time } = reqBody;

//     // Validate required fields
//     if (!id || !label || !amount || !time) {
...
//     const existingPayment = await Payment.findOne({ id });
//     if (existingPayment) {
//       return NextResponse.json({
//         message: "Payment with this ID already exists",
//         success: false,
//         status: 400,
//       });
//     }
